...
##Resposta: Por nenhum salário se repetir, não há diferença no resultado ao usar "DISTINCT"
...
#16) wAs seguintes cláusulas WHERE são logicamente equivalentes? WHERE STATE = 'MA' OR (ACRES \> 1000 AND FEE = 0.0) WHERE (STATE = 'MA' OR ACRES \> 1000) AND (STATE = 'MA' OR FEE = 0.0)

##Resposta: 
Neste caso não são logicamente equivalentes
...
##Resposta: 
A primeira é equivalente com a segunda, mas ambas não são equivalentes à terceira
